			...
			<div className="w-full max-w-5xl">
				<div className="mb-8">
					...
					<p className="mt-1 text-gray-400 text-sm">
						...
						{' — '}data aceita em <code className="text-emerald-400">dd/mm/aaaa</code> ou{' '}
						<code className="text-emerald-400">aaaa-mm-dd</code>. Moeda: <code className="text-emerald-400">BRL</code>{' '}
						ou <code className="text-emerald-400">USD</code> (padrão: BRL). Linhas com{' '}
